...
class UClass* UWB_PostMatch_TeamSummary_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WB_PostMatch_TeamSummary_C");

	return Clss;
}


// WB_PostMatch_TeamSummary_C WB_PostMatch_TeamSummary.Default__WB_PostMatch_TeamSummary_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWB_PostMatch_TeamSummary_C* UWB_PostMatch_TeamSummary_C::GetDefaultObj()
{
	static class UWB_PostMatch_TeamSummary_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWB_PostMatch_TeamSummary_C*>(UWB_PostMatch_TeamSummary_C::StaticClass()->DefaultObject);
...
void UWB_PostMatch_TeamSummary_C::Construct()
{
	...
	if (!Func)
		Func = Class->GetFunction("WB_PostMatch_TeamSummary_C", "Construct");
...
void UWB_PostMatch_TeamSummary_C::TimeRefresh()
{
	...
	if (!Func)
		Func = Class->GetFunction("WB_PostMatch_TeamSummary_C", "TimeRefresh");
