...
{
public:
	uint8                                        Pad_E8A[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	class UFieldSystem*                          FieldSystem;                                       // 0x3D8(0x8)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_EA3[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<TSoftObjectPtr<class AChaosSolverActor>> SupportedSolvers;                                  // 0x3F0(0x10)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_EE5[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
