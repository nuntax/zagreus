...
public:
	...
	enum class EMagicLeapIdentityError RequestAttributeValueAsync(TArray<enum class EMagicLeapIdentityKey>& RequestedAttributeList, UDelegateProperty_& ResultDelegate);
	...
	void GetAllAvailableAttributesAsync(UDelegateProperty_& ResultDelegate);
