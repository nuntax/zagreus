...
public:
	...
	uint8                                        Pad_B26[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_B2D[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FMovieSceneActorReferenceKey>  KeyValues;                                         // 0x30(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_B2E[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_B37[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_B3A[0x1C];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	class UProperty*                             BoundObjectProperty;                               // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FMovieSceneEventPtrs                  Ptrs;                                              // 0x0(0x10)(NoDestructor, NativeAccessSpecifierPublic)
};
...
{
public:
	uint8                                        Pad_B45[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_B4B[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	struct FMovieSceneEventPtrs                  EventToTrigger;                                    // 0x38(0x10)(NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_B66[0x67];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_B75[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B7C[0x1C];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
