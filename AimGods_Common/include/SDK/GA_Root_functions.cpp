...
class UClass* UGA_Root_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Root_C");

	return Clss;
}


// GA_Root_C GA_Root.Default__GA_Root_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Root_C* UGA_Root_C::GetDefaultObj()
{
	static class UGA_Root_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Root_C*>(UGA_Root_C::StaticClass()->DefaultObject);
...
void UGA_Root_C::EventReceived_7897C47B4073DF74733EC89C2DCF30A0(const struct FGameplayEventData& Payload)
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Root_C", "EventReceived_7897C47B4073DF74733EC89C2DCF30A0");

	Params::UGA_Root_C_EventReceived_7897C47B4073DF74733EC89C2DCF30A0_Params Parms{};
...
void UGA_Root_C::InvalidHandle_A5A10FE440F020C4746FA8A26ACB2EF1(struct FGameplayEffectRemovalInfo& GameplayEffectRemovalInfo)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GA_Root_C", "InvalidHandle_A5A10FE440F020C4746FA8A26ACB2EF1");

	Params::UGA_Root_C_InvalidHandle_A5A10FE440F020C4746FA8A26ACB2EF1_Params Parms{};
...
void UGA_Root_C::OnRemoved_A5A10FE440F020C4746FA8A26ACB2EF1(struct FGameplayEffectRemovalInfo& GameplayEffectRemovalInfo)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GA_Root_C", "OnRemoved_A5A10FE440F020C4746FA8A26ACB2EF1");

	Params::UGA_Root_C_OnRemoved_A5A10FE440F020C4746FA8A26ACB2EF1_Params Parms{};
...
void UGA_Root_C::K2_ActivateAbility()
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Root_C", "K2_ActivateAbility");
...
void UGA_Root_C::K2_OnEndAbility(bool bWasCancelled)
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Root_C", "K2_OnEndAbility");

	Params::UGA_Root_C_K2_OnEndAbility_Params Parms{};
