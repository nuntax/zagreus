...
{
public:
	UMulticastInlineDelegateProperty_            OnUrlChanged;                                      // 0x108(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastInlineDelegateProperty_            OnBeforePopup;                                     // 0x118(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_8BE[0x17];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_8CF[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
