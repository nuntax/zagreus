...
{
public:
	struct FClothConfig                          ClothConfig;                                       // 0xA8(0xD4)(Deprecated, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_D80[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FClothLODData>                 LODData;                                           // 0x180(0x10)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
