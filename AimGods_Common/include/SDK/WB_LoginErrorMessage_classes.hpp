...
public:
	...
	class UTextBlock*                            TextError;                                         // 0x238(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class FString                                ErrorMessageText;                                  // 0x250(0x10)(Edit, BlueprintVisible, ZeroConstructor, ExposeOnSpawn, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UWB_LoginErrorMessage_C* GetDefaultObj();

	void Construct();
	void BndEvt__WB_Btn_Back_K2Node_ComponentBoundEvent_1_Clicked__DelegateSignature();
	void ExecuteUbergraph_WB_LoginErrorMessage(int32 EntryPoint, class FText CallFunc_Conv_StringToText_ReturnValue);
};
