...
{
public:
	uint8                                        Pad_D63[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	UMulticastInlineDelegateProperty_            OnCameraCut;                                       // 0x870(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_D76[0x108];                                    // Fixing Size Of Struct [ Dumper-7 ]
