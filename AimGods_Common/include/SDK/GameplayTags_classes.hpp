...
public:
	...
	uint8                                        Pad_D0A[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D0E[0x98];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FGameplayTagSource>            TagSources;                                        // 0xC0(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_D0F[0xE0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
