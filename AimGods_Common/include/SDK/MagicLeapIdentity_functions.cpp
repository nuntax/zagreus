...
enum class EMagicLeapIdentityError UMagicLeapIdentity::RequestAttributeValueAsync(TArray<enum class EMagicLeapIdentityKey>& RequestedAttributeList, UDelegateProperty_& ResultDelegate)
{
	static class UFunction* Func = nullptr;
...
void UMagicLeapIdentity::GetAllAvailableAttributesAsync(UDelegateProperty_& ResultDelegate)
{
	static class UFunction* Func = nullptr;
