...
public:
	...
	class UClass*                                ShoutOfTerrorGEClass;                              // 0x4C8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UGA_ShoutOfTerror_new_C* GetDefaultObj();
