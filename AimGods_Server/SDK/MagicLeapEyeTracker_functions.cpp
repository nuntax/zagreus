...
bool UMagicLeapEyeTrackerFunctionLibrary::GetFixationComfort(struct FMagicLeapFixationComfort* FixationComfort)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("MagicLeapEyeTrackerFunctionLibrary", "GetFixationComfort");

	Params::UMagicLeapEyeTrackerFunctionLibrary_GetFixationComfort_Params Parms{};
	...
	if (FixationComfort != nullptr)
		*FixationComfort = std::move(Parms.FixationComfort);
