...
{
public:
	uint8                                        Pad_9D4[0x80];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_9DC[0xB];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9E0[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_9FA[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
