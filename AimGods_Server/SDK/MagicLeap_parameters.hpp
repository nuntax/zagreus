...
{
public:
	TSet<enum class EMagicLeapHeadTrackingMapEvent> MapEvents;                                         // 0x0(0x50)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	...
	UDelegateProperty_                           ResultDelegate;                                    // 0x38(0x10)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
