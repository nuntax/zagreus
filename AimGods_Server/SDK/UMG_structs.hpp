...
{
public:
	uint8                                        Pad_10E3[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_10E4[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_10F1[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
