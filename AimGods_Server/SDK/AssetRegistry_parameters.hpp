...
public:
	...
	uint8                                        Pad_C55[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_C5D[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	bool                                         ReturnValue;                                       // 0x19(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_C68[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_C80[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
