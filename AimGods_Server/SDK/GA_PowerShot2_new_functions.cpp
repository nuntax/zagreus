...
class UClass* UGA_PowerShot2_new_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_PowerShot2_new_C");

	return Clss;
}


// GA_PowerShot2_new_C GA_PowerShot2_new.Default__GA_PowerShot2_new_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_PowerShot2_new_C* UGA_PowerShot2_new_C::GetDefaultObj()
{
	static class UGA_PowerShot2_new_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_PowerShot2_new_C*>(UGA_PowerShot2_new_C::StaticClass()->DefaultObject);
...
void UGA_PowerShot2_new_C::EventReceived_ED9677824316327FCB04A886A2735AF6(const struct FGameplayEventData& Payload)
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_PowerShot2_new_C", "EventReceived_ED9677824316327FCB04A886A2735AF6");

	Params::UGA_PowerShot2_new_C_EventReceived_ED9677824316327FCB04A886A2735AF6_Params Parms{};
...
void UGA_PowerShot2_new_C::InvalidHandle_10029C514423AD1B2E03CCA1275B9603(struct FGameplayEffectRemovalInfo& GameplayEffectRemovalInfo)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GA_PowerShot2_new_C", "InvalidHandle_10029C514423AD1B2E03CCA1275B9603");

	Params::UGA_PowerShot2_new_C_InvalidHandle_10029C514423AD1B2E03CCA1275B9603_Params Parms{};
...
void UGA_PowerShot2_new_C::OnRemoved_10029C514423AD1B2E03CCA1275B9603(struct FGameplayEffectRemovalInfo& GameplayEffectRemovalInfo)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GA_PowerShot2_new_C", "OnRemoved_10029C514423AD1B2E03CCA1275B9603");

	Params::UGA_PowerShot2_new_C_OnRemoved_10029C514423AD1B2E03CCA1275B9603_Params Parms{};
...
void UGA_PowerShot2_new_C::K2_ActivateAbility()
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_PowerShot2_new_C", "K2_ActivateAbility");
...
void UGA_PowerShot2_new_C::K2_OnEndAbility(bool bWasCancelled)
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_PowerShot2_new_C", "K2_OnEndAbility");

	Params::UGA_PowerShot2_new_C_K2_OnEndAbility_Params Parms{};
