...
public:
	...
	class UTextBlock*                            Txt_ErrorMessage;                                  // 0x238(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	static class UWB_ErrorPopUp_C* GetDefaultObj();

	void Construct();
	void BndEvt__WB_Btn_Back_K2Node_ComponentBoundEvent_1_Clicked__DelegateSignature();
	void ExecuteUbergraph_WB_ErrorPopUp(int32 EntryPoint, class FText CallFunc_Conv_StringToText_ReturnValue);
};
