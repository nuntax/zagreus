...
{
public:
	uint8                                        Pad_4E7[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4E9[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_4EA[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4EB[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
