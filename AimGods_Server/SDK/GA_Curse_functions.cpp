...
class UClass* UGA_Curse_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Curse_C");

	return Clss;
}


// GA_Curse_C GA_Curse.Default__GA_Curse_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Curse_C* UGA_Curse_C::GetDefaultObj()
{
	static class UGA_Curse_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Curse_C*>(UGA_Curse_C::StaticClass()->DefaultObject);
...
void UGA_Curse_C::EventReceived_555AAEF74EA92E3AE9297A9137BBC146(const struct FGameplayEventData& Payload)
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Curse_C", "EventReceived_555AAEF74EA92E3AE9297A9137BBC146");

	Params::UGA_Curse_C_EventReceived_555AAEF74EA92E3AE9297A9137BBC146_Params Parms{};
...
void UGA_Curse_C::InvalidHandle_D47480A34760B7274C35AE8109DE370F(struct FGameplayEffectRemovalInfo& GameplayEffectRemovalInfo)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GA_Curse_C", "InvalidHandle_D47480A34760B7274C35AE8109DE370F");

	Params::UGA_Curse_C_InvalidHandle_D47480A34760B7274C35AE8109DE370F_Params Parms{};
...
void UGA_Curse_C::OnRemoved_D47480A34760B7274C35AE8109DE370F(struct FGameplayEffectRemovalInfo& GameplayEffectRemovalInfo)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GA_Curse_C", "OnRemoved_D47480A34760B7274C35AE8109DE370F");

	Params::UGA_Curse_C_OnRemoved_D47480A34760B7274C35AE8109DE370F_Params Parms{};
...
void UGA_Curse_C::K2_ActivateAbility()
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Curse_C", "K2_ActivateAbility");
...
void UGA_Curse_C::K2_OnEndAbility(bool bWasCancelled)
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Curse_C", "K2_OnEndAbility");

	Params::UGA_Curse_C_K2_OnEndAbility_Params Parms{};
