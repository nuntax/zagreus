...
class UClass* UGA_Voodoo_New_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Voodoo_New_C");

	return Clss;
}


// GA_Voodoo_New_C GA_Voodoo_New.Default__GA_Voodoo_New_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Voodoo_New_C* UGA_Voodoo_New_C::GetDefaultObj()
{
	static class UGA_Voodoo_New_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Voodoo_New_C*>(UGA_Voodoo_New_C::StaticClass()->DefaultObject);
...
void UGA_Voodoo_New_C::K2_ActivateAbility()
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Voodoo_New_C", "K2_ActivateAbility");
