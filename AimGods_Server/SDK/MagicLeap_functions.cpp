...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// TSet<enum class EMagicLeapHeadTrackingMapEvent>MapEvents                                                        (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UClass* UMeshTrackerComponent::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MeshTrackerComponent");

	return Clss;
}


// MeshTrackerComponent MagicLeap.Default__MeshTrackerComponent
// (Public, ClassDefaultObject, ArchetypeObject)

class UMeshTrackerComponent* UMeshTrackerComponent::GetDefaultObj()
{
	static class UMeshTrackerComponent* Default = nullptr;

	if (!Default)
		Default = static_cast<UMeshTrackerComponent*>(UMeshTrackerComponent::StaticClass()->DefaultObject);
...
void UMeshTrackerComponent::SelectMeshBlocks(struct FMagicLeapTrackingMeshInfo& NewMeshInfo, TArray<struct FMagicLeapMeshBlockRequest>* RequestedMesh)
{
	...
	Params::UMeshTrackerComponent_SelectMeshBlocks_Params Parms{};
...
void UMeshTrackerComponent::OnMeshTrackerUpdated__DelegateSignature(const struct FGuid& ID, TArray<struct FVector>& Vertices, TArray<int32>& Triangles, TArray<struct FVector>& Normals, TArray<float>& Confidence)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("MeshTrackerComponent", "OnMeshTrackerUpdated__DelegateSignature");

	Params::UMeshTrackerComponent_OnMeshTrackerUpdated__DelegateSignature_Params Parms{};
...
int32 UMeshTrackerComponent::GetNumQueuedBlockUpdates()
{
	...
	Params::UMeshTrackerComponent_GetNumQueuedBlockUpdates_Params Parms{};
...
void UMeshTrackerComponent::DisconnectMRMesh(class UMRMeshComponent* InMRMeshPtr)
{
	...
	Params::UMeshTrackerComponent_DisconnectMRMesh_Params Parms{};
...
void UMeshTrackerComponent::ConnectMRMesh(class UMRMeshComponent* InMRMeshPtr)
{
	...
	Params::UMeshTrackerComponent_ConnectMRMesh_Params Parms{};
...
void UMeshTrackerComponent::ConnectBlockSelector(TScriptInterface<class IMagicLeapMeshBlockSelectorInterface> Selector)
{
	...
	Params::UMeshTrackerComponent_ConnectBlockSelector_Params Parms{};
...
bool UMagicLeapRaycastComponent::RequestRaycast(struct FMagicLeapRaycastQueryParams& RequestParams, UDelegateProperty_& ResultDelegate)
{
	static class UFunction* Func = nullptr;
