...
void InitClientAndConnect()
{
    ...
    std::wstring username = std::wstring(usernamefrombson.begin(), usernamefrombson.end());
    auto GWorld = SDK::UWorld::GetWorld();
    auto Instance = static_cast<SDK::UBP_AGGameInstance_C*>(GWorld->OwningGameInstance);
