...
struct UBTTask_FindTower_C_ReceiveExecuteAI_Params
{
public:
...
struct UBTTask_FindTower_C_ExecuteUbergraph_BTTask_FindTower_Params
{
public:
	...
	class AAGAIController*                       K2Node_DynamicCast_AsAGAIController;               // 0x18(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x20(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_1346[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class AAGTowerBase*                          CallFunc_GetTowerToAttack_ReturnValue;             // 0x28(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
