...
public:
	...
	uint8                                        Pad_C2[0xF];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_D0[0xC];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_189[0xF];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	enum class EAREye                            Eye;                                               // 0x0(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_18C[0xF];                                      // Fixing Size After Last Property  [ Dumper-7 ]
