...
class UClass* UGA_Heal2_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Heal2_C");

	return Clss;
}


// GA_Heal2_C GA_Heal2.Default__GA_Heal2_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Heal2_C* UGA_Heal2_C::GetDefaultObj()
{
	static class UGA_Heal2_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Heal2_C*>(UGA_Heal2_C::StaticClass()->DefaultObject);
...
void UGA_Heal2_C::EventReceived_4E3B9D16429C9582D1AD04ACCA34B8C8(const struct FGameplayEventData& Payload)
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Heal2_C", "EventReceived_4E3B9D16429C9582D1AD04ACCA34B8C8");

	Params::UGA_Heal2_C_EventReceived_4E3B9D16429C9582D1AD04ACCA34B8C8_Params Parms{};
...
void UGA_Heal2_C::InvalidHandle_2BE542BE4327E15B41826E80C59D30B4(struct FGameplayEffectRemovalInfo& GameplayEffectRemovalInfo)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GA_Heal2_C", "InvalidHandle_2BE542BE4327E15B41826E80C59D30B4");

	Params::UGA_Heal2_C_InvalidHandle_2BE542BE4327E15B41826E80C59D30B4_Params Parms{};
...
void UGA_Heal2_C::OnRemoved_2BE542BE4327E15B41826E80C59D30B4(struct FGameplayEffectRemovalInfo& GameplayEffectRemovalInfo)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GA_Heal2_C", "OnRemoved_2BE542BE4327E15B41826E80C59D30B4");

	Params::UGA_Heal2_C_OnRemoved_2BE542BE4327E15B41826E80C59D30B4_Params Parms{};
...
void UGA_Heal2_C::K2_ActivateAbility()
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Heal2_C", "K2_ActivateAbility");
...
void UGA_Heal2_C::K2_OnEndAbility(bool bWasCancelled)
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Heal2_C", "K2_OnEndAbility");

	Params::UGA_Heal2_C_K2_OnEndAbility_Params Parms{};
