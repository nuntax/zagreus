...
class UClass* UGA_IntimidatingRoar_new_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_IntimidatingRoar_new_C");

	return Clss;
}


// GA_IntimidatingRoar_new_C GA_IntimidatingRoar_new.Default__GA_IntimidatingRoar_new_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_IntimidatingRoar_new_C* UGA_IntimidatingRoar_new_C::GetDefaultObj()
{
	static class UGA_IntimidatingRoar_new_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_IntimidatingRoar_new_C*>(UGA_IntimidatingRoar_new_C::StaticClass()->DefaultObject);
...
void UGA_IntimidatingRoar_new_C::K2_ActivateAbility()
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_IntimidatingRoar_new_C", "K2_ActivateAbility");
