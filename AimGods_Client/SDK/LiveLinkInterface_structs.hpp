...
{
public:
	uint8                                        Pad_5FF[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_600[0x140];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_60A[0xB];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_614[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
